...
def build_image() -> None:
    ...
    subprocess.run(
        ["docker", "build", "-f", str(PROJECT / "simulation/Dockerfile.real"),
         "-t", IMAGE, str(PROJECT)],
        check=True
    )
...
def main() -> None:
    ...
    parser.add_argument("--genesis-dir", type=str, default=None,
                        help="Path to genesis directory (default: simulation/genesis_real/<n>)")
    ...
    if args.genesis_dir:
        ...
        genesis_dir = PROJECT / "simulation" / "genesis_real" / str(n)
