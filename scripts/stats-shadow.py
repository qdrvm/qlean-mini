#!/usr/bin/env python3
"""Print attestation propagation stats from a Shadow simulation run.

Usage:
  uv run scripts/stats-shadow.py           # default: 64 nodes, all slots
  uv run scripts/stats-shadow.py 4         # 4-node run
  uv run scripts/stats-shadow.py 64 5      # 64 nodes, focus on slot 5
  uv run scripts/stats-shadow.py 64 --all  # show all per-slot P99 values
"""
