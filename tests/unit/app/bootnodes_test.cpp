...
TEST(BootnodeTest, ENRParsing) {
  ...
  std::string test_enr =
      "enr:-"
      "IW4QHcpC4AgOv7WXk1V8E56DDAy6KJ09VMOxSTUwgOqkLF6YihJc5Eoeo4UX1bm9H39Xl-"
      "831fomuqR3TZzB3S2IPoBgmlkgnY0gmlwhH8AAAGEcXVpY4InEIlzZWNwMjU2azGhA21sqsJ"
      "Ir5b2r6f5BPVQJToPPvP1qi_mg4qVshZpFGji";
  ...
  EXPECT_EQ(retrieved_bootnodes[0].address.getStringAddress(),
            connect_addr.getStringAddress());
}
